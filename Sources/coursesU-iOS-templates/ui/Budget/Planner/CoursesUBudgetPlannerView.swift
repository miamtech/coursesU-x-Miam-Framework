...
//        CoursesUBudgetPlannerView(toolbarTemplate: CoursesUBudgetPlannerToolbar(), recipeCardTemplate: , loadingCardTemplate: <#T##_#>, placeholderCardTemplate: <#T##_#>, recipes: <#T##[String]#>, validateRecipes: <#T##() -> Void#>, replaceRecipe: <#T##(String) -> Void#>)
//    }
//}
