...
@available(iOS 14, *)
struct CoursesURecipeCardDetailsModal: RecipeCardDetailsModal {
    ...
    func content(recipeId: String, price: Price, recipeViewModel: RecipeCardVM, close: @escaping () -> Void) -> some View {
