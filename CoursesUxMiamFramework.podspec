Pod::Spec.new do |spec|
    ...
    spec.version      = "5.2.4"
    spec.summary      = "Mealz iOS SDK for Courses U"
    ...
    spec.source       = { :git => "https://github.com/miamtech/coursesU-x-Miam-Framework.git", :tag => "5.2.4" }
    spec.source_files = 'Sources/**/*.{h,m,swift}'
    spec.dependency 'MealziOSSDK', '5.2.4'
